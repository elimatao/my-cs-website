...
$$
\sum{^{2}_{k=1} \pi*n^2} + \frac{3}{2} - \omega * \Theta
$$
Hallo
...
{{< img_resp_old src="ny.jpg" alt="New York" class="float-md-right" width="60%" width_switch="992px">}}
...
{{< img_resp src="ny.jpg" alt="New York">}}
