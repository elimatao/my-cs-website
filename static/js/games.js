...
function LEDModeControl(){
	...
	if (mode === "normal"){
		...
		LEDDiv.innerHTML = `<img class="LED" src="/static/LEDOff.png"><img class="LED" src="/static/LEDOff.png">
							<img class="LED" src="/static/LEDOff.png"><img class="LED" src="/static/LEDOff.png">
							<img class="LED" src="/static/LEDOff.png"><img class="LED" src="/static/LEDOff.png">
							<img class="LED" src="/static/LEDOff.png"><img class="LED" src="/static/LEDOff.png">`;
...
function bin(n, pos, leds)
{
	...
	if (n % 2 == 1) leds[pos].src = "/static/LEDOn.png";
	n = Math.floor(n / 2);
	bin(n, pos - 1, leds);
}
